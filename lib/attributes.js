class t_attribute {
  ...
  clone(attribute) {
    ...
    this.opcodes = attribute.opcodes;
  ...
  copy() {
    ...
    attribute.opcodes = this.opcodes;
  ...
  type_dummy() { return this.default_id == -1; }
  type_remove() { return this.default_id == -2; }
  type_remove_all() { return this.default_id == -3; }
